...
import 'package:google_maps_integration/locations.g.dart';
...
class Office {
  ...
  factory Office.fromJson(Map<String, dynamic> json) => $OfficeFromJson(json);
  Map<String, dynamic> toJson() => $OfficeToJson(this);
